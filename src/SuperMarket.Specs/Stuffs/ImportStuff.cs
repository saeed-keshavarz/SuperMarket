...
InOrderTo = "و آن را به فروش برسانم "
    ...
    public class ImportStuff : EFDataContextDatabaseFixture
    {
        ...
        private readonly StuffService _sutStuff;
        private readonly VoucherService _sutVoucher;
        ...
        public ImportStuff(ConfigurationFixture configuration) : base(configuration)
        {
            ...
            _stuffRepository = new EFStuffRepository(_dataContext);
            _sutStuff = new StuffAppService(_stuffRepository, _unitOfWork);

            _voucherRepository = new EFVoucherRepository(_dataContext);
            _sutVoucher = new VoucherAppService(_voucherRepository, _unitOfWork);
        }
        ...
        public void When()
        {
            ...
            {
                Title = "سند: " + _stuff.Title + DateTime.Now.Year,
             ...
             _sutVoucher.Add(_dto);
            _sutStuff.UpdateInventory(_stuff.Id, _dto.Quantity);
